        ...
        <div class="px-6 h-full text-gray-800">
            <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                <div class="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 lg:w-6/12 md:w-9/12 mb-12 md:mb-0">
                    ...
                    <img src="https://img.freepik.com/free-vector/silhouette-skyline-illustration_53876-78786.jpg?t=st=1654341542~exp=1654342142~hmac=0cd3b794777004dbf8728500545b637fff092557567ccd8280081a30902a78ee&w=900"
                        class="w-full" alt="Sample image" />
                </div>
                    ...
                    <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <input type="text"
                                ...
                                id="nama" name="nama" placeholder="Fullname" value="{{  old('nama') }}" />
                                @error('nama')
                        ...
                        <div class="mb-6">
                            <input type="text"
                                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="alamat" name="alamat" placeholder="Address" value="{{  old('alamat') }}" />
                                @error('alamat')
                                        <div class="alert alert-danger">{{ $message }}</div>
                        ...
                        <div class="mb-6">
                            <input type="text"
                                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="nohp" name="nohp" placeholder="Phone Number" value="{{  old('nohp') }}" />
                                @error('nohp')
                                        <div class="alert alert-danger">{{ $message }}</div>
                        ...
                        <div class="text-center lg:text-left">
                            ...
                            {{-- <a href="superadmin" class="inline-block px-7 py-3 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Register</a> --}}
                            {{-- <input type="submit" name="submit" id="submit" value="submit    " class="inline-block px-7 py-3 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                            <p class="text-sm font-semibold mt-2 pt-1 mb-0">
                                Don't have an account?

                                    <input type="submit" name="submit" id="submit" value="Register" class="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out">
                            </p> --}}
                        </div>
                    </form>
                </div>
